...
export class DynamicCustomerLookup extends LitElement {
  ...
  return {
    version: "1.0",
    controlName: "Dynamic Customer Lookup",
...
customElements.define('dynamic-customer-lookup', DynamicCustomerLookup);