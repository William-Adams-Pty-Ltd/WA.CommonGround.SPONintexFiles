...
export class GetCustomerDropdown extends LitElement {
  static properties = {
  ...
  static getMetaConfig() {
    return {
      controlName: 'Customer Dropdown V2',
      version: '1.0',
  ...
  selectCustomer(cust) {
    ...
    this.jsonOut = { CustomerName: cust.CustomerName };
...
customElements.define('getcustomer-dropdown', GetCustomerDropdown);
