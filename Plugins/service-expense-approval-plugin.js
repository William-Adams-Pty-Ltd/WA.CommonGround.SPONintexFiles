  ...
  _restoreFromTextarea() {
    ...
    if ([valueToSelect].length == 1) {
      this.updateComplete.then(() => {
        ...
        console.log('[Plugin] _restoreFromTextarea: ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ segment restored silently =>', valueToSelect);
      });
      return;
    }
  }
  ...
  _preselectFromTextarea() {
    ...
    this.updateComplete.then(() => {
      ...
      this.updateComplete.then(() => {
        ...
        console.log('[Plugin] _preselectFromTextarea: ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ pre-selection complete =>', this.selectedSegment);
      });
    });
  }
